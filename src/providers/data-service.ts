...
export class DataService {
  ...
  girls: Array<string> = ['assets/images/girl1.jpg','assets/images/girl2.jpg','assets/images/girl3.jpg','assets/images/girl4.jpg','assets/images/girl5.jpg'];
  ...
  constructor(public http: Http) {
    ...
    for(let i of [1,2,3,4,5,6,7]){
      this.conversations.push(new Conversation('convo'+(i+3),'userCode0','userCode'+(i+1),'Whatsaaap?'))
    };
  ...
  loadData(){
    ...
    let newNews1 = new Post('testCode1','userCode1','business','','LADIES NIGHT','Arguably the best in central London, the Roxy’s rooftop deck offers stunning views of the midtown city skyline.','assets/images/gallery.jpg','','12.3','3.4','32.1','eventCode1');
    let newNews2 = new Post('testCode2','userCode2','business','','HUNTED HALLOWEEN','Enjoy a cocktail or two from the comprehensive cocktail list with enticing choices like the Café Le Peche, an espresso martini with a twist.','assets/images/club3.jpg','','11.3','10.4','32.1','eventCode2');
    let newNews3 = new Post('testCode3','userCode3','individual','','','TGIF People, lets meet up and get on it','','assets/images/profile4.jpg','0','0','0','eventCode2');
    ...
    let newUser1 = new User('userCode1','business','Deep Dome','G','C','C','M','O','I','O','H','N','D','S','A',4,2145,456,'Dance','18+','Dress to impress',500,'234 High Street','test@deepdome.com','assets/images/logo2.jpg','assets/images/gallery.jpg','hashTest');
    let newUser2 = new User('userCode2','business','Pure Night CLub','G','C','C','M','O','I','O','H','N','D','S','A',5,2000,1560,'Electro','18+','Formal',500,'1A Vault Drive','test@nightclub.com','assets/images/logo.jpg','assets/images/banner1.jpg','hashTest');
    let newUser3 = new User('userCode3','individual','Paula Rain','Female','London','UK','M','Accountant','Single','Straight',1.75,'British',true,true,'Looking for some fun',0,350,150,'G','A','D','C','Address','paula@gmail.com','assets/images/profile2.jpg','','hashTest');
    let newUser4 = new User('userCode4','individual','Jemma','Female','Paris','France','M','Retail','Single','Straight',1.80,'French',true,true,'Lets drink',0,133,76,'G','A','D','C','Address','jemma@gmail.com','assets/images/girl5.jpg','','hashTest');


    let newUser5 = new User('userCode5','individual','Sara Beaz','Female','Mexico City','Mexico','M','Accountant','Single','Straight',1.75,'British',true,true,'Looking for some fun',0,350,150,'G','A','D','C','Address','paula@gmail.com','assets/images/profile5.jpg','','hashTest');
    let newUser6 = new User('userCode6','individual','James Hussein','Male','Shenzhen','China','M','Retail','Single','Straight',1.80,'French',true,true,'Lets drink',0,133,76,'G','A','D','C','Address','jemma@gmail.com','assets/images/profile6.jpg','','hashTest');
    let newUser7 = new User('userCode7','individual','Karemiks','Male','London','UK','M','Accountant','Single','Straight',1.75,'British',true,true,'Looking for some fun',0,350,150,'G','A','D','C','Address','paula@gmail.com','assets/images/profile7.jpg','','hashTest');
    let newUser8 = new User('userCode8','individual','Tiffany Watson','Female','Apia','Samia','M','Retail','Single','Straight',1.80,'French',true,true,'Lets drink',0,133,76,'G','A','D','C','Address','jemma@gmail.com','assets/images/profile8.jpg','','hashTest');
    let newUser9 = new User('userCode9','individual','Megan Left','Auckland','New Zealand','UK','M','Accountant','Single','Straight',1.75,'British',true,true,'Looking for some fun',0,350,150,'G','A','D','C','Address','paula@gmail.com','assets/images/profile9.jpg','','hashTest');
    let newUser10 = new User('userCode10','individual','Pauline','Female','Suva','Fiji','M','Retail','Single','Straight',1.80,'French',true,true,'Lets drink',0,133,76,'G','A','D','C','Address','jemma@gmail.com','assets/images/profile10.jpg','','hashTest');
    ...
    let newEvent1 = new Event ('eventCode1','userCode1','LADIES NIGHT','Arguably the best in central London, the Roxy’s rooftop deck offers stunning views of the midtown city skyline.','101 The Avenue, Dunedin','Dance','Formal','Friday, 1st September','10:00','4:00','assets/images/gallery.jpg','assets/images/event.jpg','12.3','3.4');
    ...
    let venue1 = new Venue('venueCode1','Venue 1',0,'assets/images/venue1.png','assets/images/venue1.jpg');
    let venue2 = new Venue('venueCode2','Venue 2',0,'assets/images/venue4.jpg','assets/images/venue2.jpg');
    let venue3 = new Venue('venueCode3','Venue 3',0,'assets/images/venue2.png','assets/images/venue3.jpg');
